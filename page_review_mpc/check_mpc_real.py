...
class MPCController:
    ...
    def mpc_control(self, x, y, theta):
        ...
        prediction_horizon = self.lookahead_max * 0.8333 
        num_samples = 3
...
# [SỬA ĐỔI] Thay đổi logic của nút "Go to Pose"
# ==============================================================================
...
class GUI:
    def __init__(self, master, mpc_controller):
        ...
        # --- [SỬA ĐỔI] Khung "Go to Pose" giờ sẽ publish tới /move_base_simple/goal
        ...
        # --- [SỬA ĐỔI] Thêm publisher cho /move_base_simple/goal
    ...
    # --- [SỬA ĐỔI] Hàm này đã được viết lại hoàn toàn
    def go_to_pose(self):
        """
