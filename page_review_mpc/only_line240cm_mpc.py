...
# [SỬA ĐỔI] Thay đổi hàm generate_example_path
# ==============================================================================
...
class PathManager:
    ...
    # --- [SỬA ĐỔI] Chỉ tạo một đường thẳng dài 3m ---
    def generate_example_path(self, start_pose):
        ...
        # Tạo một phân đoạn đường thẳng duy nhất dài 3.0 mét theo hướng hiện tại của robot
        end_point = p0 + 2.4 * np.array([np.cos(theta0), np.sin(theta0)])
        line_seg = LineSegment(p0, end_point)
        self.add_segment(line_seg)
        
        # Xóa bỏ việc tạo các phân đoạn đường cong và spline
